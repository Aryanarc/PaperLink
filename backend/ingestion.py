...
# embed_and_store is called from main.py, not here — that import was dead and
# risked a circular import (vector_store -> ingestion on some Python versions)


def extract_text_from_pdf(pdf_path: str) -> list[dict]:
    doc = fitz.open(pdf_path)
    # opens a PDF and returns a list of pages,
